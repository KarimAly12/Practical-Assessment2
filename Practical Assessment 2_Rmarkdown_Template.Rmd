...
In this R code, we aim to reduce the skewness of the price_per_sqft variable in our dataset, merged_df, by applying a log transformation. We start by loading the necessary libraries: dplyr for data manipulation and moments for calculating skewness. First, we calculate and print the skewness of price_per_sqft before applying any transformations to see how skewed the data is.
